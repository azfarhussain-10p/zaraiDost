...
if (Platform.OS !== 'web') {
  ...
  runMigration009 = require('../migrations/009_suppliers').runMigration009;
}
...
const checkAndMigrate = async (db) => {
  try {
    ...
    if (currentVersion < DATABASE_VERSION) {
      ...
      // Run migration 009 (Story 3.5)
      if (currentVersion < 9 && DATABASE_VERSION >= 9) {
